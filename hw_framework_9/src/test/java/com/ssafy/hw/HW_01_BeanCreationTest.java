 ...
 */
public class HW_01_BeanCreationTest extends AbstractTest{

	/**
	 * 로깅 처리를 위해 Logger를 설정한다.
	 */
	private static Logger logger = LoggerFactory.getLogger(HW_01_BeanCreationTest.class);
	...
	public void testSingleton() {
		assertEquals(prepo, ((ProductServiceImpl) pserv).getProductRepo());
	}
